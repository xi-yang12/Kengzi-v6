function [gisData, b_Idx] = createStartingBuilding(gisData, new_blocks, parent_ID)
...
gisData.PRE.buildings(b_Idx).people = gisData.PRE.buildings(b_Idx).size * gisData.PvA;
